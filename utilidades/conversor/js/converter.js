...
function DataConverter(nodeId) {
  ...
  this.outputDataTypes        = [
                                ...
                                {"text":"JSON - Propiedades",      "id":"json",             "notes":""},
                                {"text":"JSON - Array de columnas",   "id":"jsonArrayCols",    "notes":""},
                                {"text":"JSON - Array de filas",      "id":"jsonArrayRows",    "notes":""},
                                {"text":"JSON - Diccionario",      "id":"jsonDict",         "notes":""},
                                {"text":"MySQL",                  "id":"mysql",            "notes":""},
                                {"text":"PHP",                    "id":"php",              "notes":""},
                                {"text":"Python - Dict",          "id":"python",           "notes":""},
                                {"text":"Ruby",                   "id":"ruby",             "notes":""},
                                {"text":"XML - Propiedades",       "id":"xmlProperties",    "notes":""},
                                {"text":"XML - Nodes",            "id":"xml",              "notes":""},
                                {"text":"XML - Illustrator",      "id":"xmlIllustrator",   "notes":""}];
  this.outputDataType         = "xmlIllustrator";
...
DataConverter.prototype.create = function(w,h) {
  ...
  this.inputHeader = $('<div class="groupHeader" id="inputHeader"><p class="groupHeadline"> Entrada de CSV o datos delimintados por tabulador. <span class="subhead"> ¿Usando Excel? Símplemente copia y pega. ¿No tienes datos a mano? <a href="#" id="insertSample">Usar ejemplo</a></span></p></div>');
  this.inputTextArea = $('<textarea class="textInputs" id="dataInput"></textarea>');
  var outputHeaderText = '<div class="groupHeader" id="inputHeader"><p class="groupHeadline">Convertir a <select name="Data Types" id="dataSelector" >';
